...
import me from "../assets/meAiDrawing.jpg";
...
const Banner = () => {
  return (
    <section
      className="section min-h-[85vh] lg:min-h-[78vh] items-center"
      id="home"
    >
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 lg:flex-row">
          <div className="flex-1 text-center font-secondary lg:text-left lg:items-center lg:gap-x-12">
            ...
            >
              Hello World! My name is Robin and I am a web dev from the heart of
              the bluegrass. Let's break down the walls of the digital space
              together.
            </motion.p>
            <motion.div
